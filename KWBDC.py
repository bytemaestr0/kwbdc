...
filenames = []
file_counter = 1
directory = input("What directory to save the dictionary to(example: /directory/subdirectory/ ): ")
...
num_of_words = int(input("How many different word to modify: "))
...
for file in filenames:
    os.remove(file)
print(f"Dictionary saved as {final_file}")
